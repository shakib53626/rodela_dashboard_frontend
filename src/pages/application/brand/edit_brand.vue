        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="theme-form theme-form-2 mega-form" enctype="multipart/form-data" @submit.prevent="submit">
                <div class="row">
                ...
                <div class="row">
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-10">
                      ...
                      <img :src="`http://127.0.0.1:8000/images/brands/${image}`" width="100" alt="" class="mt-2" v-if="imagePreview==null">
                      <img :src="imagePreview" width="100" alt="" class="mt-2" v-else>
